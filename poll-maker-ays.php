 ...
 */
define('POLL_MAKER_AYS_VERSION', '3.3.1');
					...
					<div style="display: flex; align-items: center;">
						...
						<div style="font-size:14px; padding:12px; width: 100%;">
							...
							<strong style="font-size: 12px;">								
									...
									<br>
									<?php echo __( "Hurry up! Ends on August 10. <a href='https://ays-pro.com/mega-bundle' target='_blank'>Check it out!</a>",POLL_MAKER_AYS_NAME);?>							
							</strong>							
