                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8 ays_divider_left">
                                    ...
                                    <div class="col-sm-12 ays_toggle_target ays_divider_top ays_answer_style" style="margin-top: 10px; padding-top: 10px; <?= ($options['enable_answer_style'] == 'on') ? '' : 'display:none;' ?>">
                                        ...
                                        <div id="ays_answer_font_size_box">
                                            <input type="number" class="ays-text-input ays-text-input-short" name="ays_answer_font_size" id="ays_answer_font_size" value="<?php echo $poll_answer_font_size;?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 ays_toggle_target ays_divider_top ays_answer_style" style="margin-top: 10px; padding-top: 10px; <?= ($options['enable_answer_style'] == 'on') ? '' : 'display:none;' ?>">
                                        <div>
                                    ...
                                    <div class="" style="width: 100%;"> 
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7 ays_divider_left">
                                                <select class="ays-text-input ays-text-input-short" id="ays_answers_object_fit" name="ays_answers_object_fit" style="width:15vw;">
                                                    <option value="cover">
                                                        <?php echo __('Cover',$this->plugin_name)?>
                                                    </option>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7 ays_divider_left">
                                                <input type="checkbox" class="ays_toggle ays_toggle_slide" id="ays_answers_box_shadow" name="ays_answers_box_shadow" checked/>
                                                ...
                                                <div class="col-sm-12 ays_toggle_target ays_divider_top" style="margin-top: 10px; padding-top: 10px;">
                                                    ...
                                                    <input type="text" class="ays-text-input" data-alpha="true" data-default-color="#000000" value="#000000" id="ays_answers_box_shadow_color"/>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7 ays_divider_left">
                                                <input type="number" class="ays-text-input ays-text-input-short" value="" min="0"/>
                                            </div>
                                        </div> <!-- Answers image height -->
                                        <hr/>
									...
									switch ( $poll_view_type_text ) {
										case 'short_text':
                                            $content .= "<div class='ays-poll-maker-text-live-preview'>
                                                            <input type='text' id='ays_poll_text_type_short_live' placeholder='Short answer text' readonly>
                                                            <label for='ays_poll_text_type_short_live'></label>
                                                        </div>";											
											break;
										case 'paragraph':
                                            $content .= "<div class='ays-poll-maker-text-live-preview'>
                                                            <textarea id='ays_poll_text_type_paragraph_live' placeholder='Long answer text' readonly></textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                    	<div class="row">
		                    ...
		                    <div class="col-sm-9">
		                        <input type="text" class="ays-text-input ays-text-input-short" id="ays-poll-btn-text" name="ays_poll_res_btn_text" value="<?= (isset($options['see_res_btn_text']) && '' != $options['see_res_btn_text']) ? stripslashes($options['see_res_btn_text']) : __("See Results", $this->plugin_name); ?>"/>
		                    </div>
                    	</div>
                    </div>
                </div>
	                ...
	                <div class="form-group row ays_toggle_parent">
				        ...
				        <div class="col-sm-1">
				            <input type="checkbox" class="ays-enable-timer1 ays_toggle_checkbox" id="ays_enable_password"
				                   name="ays_enable_password" value="on">
				        </div>
				        <div class="col-sm-8 ays_toggle_target ays_divider_left">
				            <div class="form-group row">
				                <div class="col-sm-3">
