(function ($) {
                ...
                switch(textType){
                    case "short_text":
                        content += "<div class='ays-poll-maker-"+type+"-live-preview' >";
                            content += "<input type='text' id='ays_poll_text_type_short_live' placeholder='Short answer text' readonly>"
                            content += "<label for='ays_poll_text_type_short_live'></label>"
                        content += "</div>";
                        break;
                    case "paragraph":
                        content += "<div class='ays-poll-maker-"+type+"-live-preview'>";
                            content += "<textarea id='ays_poll_text_type_paragraph_live' placeholder='Long answer text' readonly></textarea>"
   ...
   function toggleBackgrounGradient() {
    ...
    $(document).on('change', '.ays-poll-question-font-size,#ays_poll_question_image_height,#ays_answers_view,#ays_poll_answer_img_height,#ays_poll_image_background_size,#ays_poll_answers_padding,#ays_poll_answers_margin,#ays_poll_title_font_size,#ays_poll_title_alignment' , function () {
    ...
    $(document).find("#ays_answer_font_size").on("change" , function(){
    ...
    function refreshLivePreview(checker){
        ...
        // Answer Font size
        var answerFontSize = $(document).find("#ays_answer_font_size").val();
        // Border color 
        ...
        $(document).find(".apm-img-box img.ays-poll-img").css({"height" : questionHeight, "object-fit" : "cover"});
    ...
    // Pro features
    $(document).find('#ays_answers_border_color,#ays_answers_box_shadow_color').wpColorPicker({
        // defaultColor: '#0C6291',
        change: function(event, ui) {
        }
    });
